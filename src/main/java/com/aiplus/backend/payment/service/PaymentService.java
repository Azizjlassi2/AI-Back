...
public class PaymentService {
    ...
    public String initiatePaymentForSubscription(Subscription subscription) {
        ...
        Payment payment = Payment.builder().transactionId(UUID.randomUUID().toString())
                .orderId(UUID.randomUUID().toString()).userId(subscription.getClient().getId())
        ...
        String msg = "Subscription payment – Plan: " + subscription.getPlan().getName();
        Map<String, Object> resp = konnectClient.initPayment(platformWalletId, amountInMillimes, payment.getOrderId(),
                webhookUrl, msg, subscription.getPlan().getModel().getId());
